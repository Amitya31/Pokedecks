async function fetchData(type,count,stateVar){
    ...
    for(let i=0;i<count;i++){
        ...
        let pokeDetails={
            ...
            // pokeImg: pokeJson.sprites.other['home']['front_default'],
            pokeImg: pokeJson.sprites.other['dream_world']['front_default'],
            ...
            pokeResistances1: typeJson.damage_relations.half_damage_from[0]?typeJson.damage_relations.half_damage_from[0].name:"-",
            pokeResistances2: typeJson.damage_relations.half_damage_from[1]?typeJson.damage_relations.half_damage_from[1].name:"-",
            pokeWeakness: typeJson.damage_relations.double_damage_from[0]?typeJson.damage_relations.double_damage_from[0].name:"-",
        }
